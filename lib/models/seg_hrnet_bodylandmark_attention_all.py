...
class LandmarkExpNetwork(ModuleWithAttr):
    ...
    def forward(self, sample):
        ...
        attention_map1 = self.attention_unit(0,hrnet_seg_x,hrnet_seg_x_list)
        attention_map2 = self.attention_unit(1,hrnet_seg_x,hrnet_seg_x_list)
        attention_map3 = self.attention_unit(2,hrnet_seg_x,hrnet_seg_x_list)
        attention_map4 = self.attention_unit(3,hrnet_seg_x,hrnet_seg_x_list)
        
        GL1 =  hrnet_seg_x_list[0] * (1 + attention_map1)
        GL2 =  hrnet_seg_x_list[1] * (1 + attention_map2)
        GL3 = hrnet_seg_x_list[2] * (1 + attention_map3)
        GL4 = hrnet_seg_x_list[3] * (1 + attention_map4)
