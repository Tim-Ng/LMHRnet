...
The .pkl files in the [pretrained models](/pretrained&#32;models) is where the train networks can be found. (needs to be download) <br>

The graph for training is saved in [pretrained models/experiment layers graph](/pretrained&#32;models/experiment&#32;layers&#32;graph) (needs to be download)  <br>
